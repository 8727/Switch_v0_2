...
extern uint8_t ws2811W[LEDS_W][LEDS_SEGMENTS];
extern uint8_t ws2811RGB[LEDS_RGB][LEDS_SEGMENTS];

uint8_t ws2811rgbDMA[LEDS_RGB + 0x02][LEDS_SEGMENTS][0x08];
uint8_t ws2811wDMA[LEDS_W + 0x02][LEDS_SEGMENTS][0x08];
...
void LEDstrip_init(void){
  ...
  DMA2_Channel1->CNDTR = (LEDS_RGB + 0x02) * LEDS_SEGMENTS *0x08;
  ...
  DMA2_Channel2->CNDTR = (LEDS_W + 0x02) * LEDS_SEGMENTS *0x08;
